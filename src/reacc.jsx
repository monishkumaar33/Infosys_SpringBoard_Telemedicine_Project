...
const CalComBooking = () => {
  ...
  return (
    <div style={containerStyle}>
      <h1 style={{ textAlign: 'center', marginBottom: '20px',color:'black' }}>📅 Schedule Appointment</h1>
      ...
      <div style={formGroupStyle}>
        <label style={labelStyle}>Select Severity</label>
        <input name = "severity"
          type="radio"
          value={severity}
          onChange={(e) => setSeverity('High')}
        />
        <label style={labelStyle}> High </label>
        <input name = "severity"
          type="radio"
          value={severity}
          onChange={(e) => setSeverity('Medium')}
        />
        <label style={labelStyle}> Medium</label>
        <input name = "severity"
          type="radio"
          value={severity}
          onChange={(e) => setSeverity('Low')}
        />
      ...
      {availableSlots.length > 0 &&(
        ...
        .filter((_, index) =>
          severity === "High" || 
          (severity === "Medium" && index % 2 === 0) || 
          (severity === "Low" && index % 3 === 0)
        )
        .map((slot, index) => (
          <button
            id="slot"
            ...
            style={{
              backgroundColor: selectedSlot === slot ? "aqua" : "black",
